const site = {
  ...
  directions:
    'Metro M5 Lilla - Fermata san Siro ippodromo oppure in auto arrivando da qualunque autostrada, immettersi nella Tangenziale Ovest, da questa uscita S. SIRO - fieraminaloncity - CENTRO, percorrere via Novara - via Harar - via dei Rospigliosi. Superato lo STADIO, girare a destra in via Pessano, indi prima a sinistra via Matteo Civitali (angolo via Pessano), al 79 EURACCIAI.'
};
...
const divisions = [
  {
    ...
    description:
      'EURACCIAI opera nel campo degli utensili da taglio e parti di usura/componenti in carburo di tungsteno da più di cinquanta anni.',
    paragraphs: [
    ...
    products: [
      {
        ...
        description:
          'Le leghe bronzo alluminio Albromet sono prodotte con tecnologie avanzate e severe procedure di controllo; disponibili anime omnidirezionali e modulari per curvatubi CNC.'
      },
      {
        title: 'Elettrodi per saldatura a resistenza',
        description:
          'Euracciai produce e fornisce elettrodi su disegno da molti anni, con verifiche sul materiale in entrata e sul 100% dei pezzi prodotti.'
      },
      {
        title: 'Lame per troncatura tubi e profilati',
        description:
          'Lame verticali e orizzontali per linee di taglio tubi e profilati, con soluzioni per acciai ferritici e austenitici.'
      },
      {
        title: 'LEGHE BRONZO-ALLUMINIO ALBROMET',
        description:
          "Leghe con alta resistenza all'usura e basse frizioni per componenti di impianto e macchine."
      },
      {
        title: 'ALBROMET Leghe di rame ad alta conducibilità',
        description:
          "Leghe in rame ad alta conducibilità per stampi e costruzione elettrodi, con elevata conducibilità termica e buona resistenza all'usura."
      },
      {
      ...
      },
      {
        ...
        description:
          'Ampia gamma a magazzino in barre tonde e quadrate, lamiere, piatti e filo, con possibilità di realizzazioni a disegno su richiesta.'
      },
      {
  ...
  },
  {
    ...
    description:
      'La divisione è specializzata in materiali avanzati per applicazioni industriali, come ceramiche tecniche, leghe resistenti alla corrosione e alle alte temperature, materiali antiusura e componenti speciali per impianti.',
    paragraphs: [
    ...
    products: [
      ...
      },
      {
        ...
        description:
          'Griglie e cilindri filtranti di precisione; nastri trasportatori laminati per forni a tunnel.',
  ...
  },
  {
    ...
    description:
      'La conoscenza approfondita dei processi tecnologici ci permette di analizzare le esigenze tecniche e di produzione e quindi di proporre le migliori soluzioni in relazione alle caratteristiche del componente da produrre, e alle esigenze di flessibilità e produttività richieste per il progetto.',
    paragraphs: [
    ...
    products: [
      {
        ...
        description:
          'Macchine per produrre componenti di precisione da tubo, barra e filo; presse orizzontali idrauliche e sistemi di rullatura ad alta precisione.',
        url: 'https://www.felss.com'
      },
      {
        title: 'WEIL-TECHNOLOGY - Germania',
        description:
          'Macchine e sistemi per tecniche innovative di formatura, taglio e giunzione, incluse linee turn-key automatizzate.',
        url: 'https://www.weil-engineering.de'
      },
      {
        title: 'WF MASCHINENBAU UND BLECHFORMTECHNIK - Germania',
        description:
          'Macchine di flow forming per pulegge, componenti di trasmissione, frizioni, dischi, ruote, bombole gas e altri componenti speciali.',
